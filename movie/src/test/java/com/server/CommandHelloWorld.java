...
public class CommandHelloWorld extends HystrixCommand<String> {
    ...
    private static final Setter cachedSetter = Setter.withGroupKey(HystrixCommandGroupKey.Factory.asKey("MyGroup"))
            .andCommandKey(HystrixCommandKey
                    .Factory.asKey("liuleicommand"));
    ...
    protected String getFallback() {
        return "oh,no! I'am Failure " + name + "!";
    }
